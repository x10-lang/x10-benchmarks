...
public class Psinv extends MGWorker {
	...
	public static def psinv(r: Array[Double](1){rail}, roff: int, 
			u: Array[Double](1){rail}, 
			uoff: int, n1: int, n2: int, n3: int, 
			r1: Array[Double](1){rail}, 
			r2: Array[Double](1){rail}, 
			c: Array[double](1), start: int, end: int)  {
		//		c---------------------------------------------------------------------
		...
		for ([i3,i2] in (start..(end-1))*(1..(n2-2))) {
			for (i1 in 0..(n1-1)) {
