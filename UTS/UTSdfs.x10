...
public class UTSdfs {
    public static def main (args:Array[String](1)) {
        try {
            ...
            val st = PlaceLocalHandle.make[ParUTSdfs](Dist.makeUnique(), ()=>new ParUTSdfs(b, d, n, w, l, lifelines(Runtime.hereInt())));
            ...
            val cl = (i:Int) => { val p = Place(i); at(p) st().logger };
            val logs = new Rail[Logger](P, cl);
