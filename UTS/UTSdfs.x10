    ...
    public static def main (args : Array[String](1)) {
        try {
            val opts = new OptionsParser(args, null,
                     ...
                     Option("a", "", "GEO: Tree shape function"),
            ...
            val st = PlaceLocalHandle.make[ParUTSdfs](Dist.makeUnique(), ()=>new ParUTSdfs(b0, a, d, k, n, w, e, l, lifelines(here.id)));
            
            Console.OUT.println("Starting...");
            //@Native("c++", "ProfilerStart(\"UTS.prof\");") {}
            var time:Long = System.nanoTime();
            st().main(st, SHA1RandXX(r));
