...
//#line 29
new x10.core.fun.Fun_0_2<FixedRailStack<T>, java.lang.Integer, java.lang.Integer>() {public final java.lang.Integer apply(final FixedRailStack<T> x, x10.rtt.Type t1,final java.lang.Integer y, x10.rtt.Type t2) { return apply(x,(int)y);}
            public final int apply(final FixedRailStack<T> x, final int y) { {
                
//#line 29
return x.size = ((((int)(x.
                                                       size))) + (((int)(y))));
            }}
            public x10.rtt.RuntimeType<?> getRTT() { return _RTT;}public x10.rtt.Type<?> getParam(int i) {if (i ==0) return new x10.rtt.ParameterizedType(FixedRailStack._RTT, T);if (i ==1) return x10.rtt.Types.INT;if (i ==2) return x10.rtt.Types.INT;return null;
            }
            }.apply(this,
                    1);
        }
...
//#line 38
return (this.
                                  internalStorage).apply$G(((int)(new x10.core.fun.Fun_0_2<FixedRailStack<T>, java.lang.Integer, java.lang.Integer>() {public final java.lang.Integer apply(final FixedRailStack<T> x, x10.rtt.Type t1,final java.lang.Integer y, x10.rtt.Type t2) { return apply(x,(int)y);}
            public final int apply(final FixedRailStack<T> x, final int y) { {
