...
public Vector(final x10.rtt.Type T,
                                 final x10.core.Rail<T> r) {this.T = T;
                                                                 {
                                                                    {
...
return new Vector<T>(T,
                                             x10.core.RailFactory.<T>makeVarRail(T, ((int)(n)), init));
        }
...
return new Vector<java.lang.Integer>(x10.rtt.Types.INT,
                                                             (new java.lang.Object() {final x10.core.Rail<java.lang.Integer> apply(int length) {int[] array = new int[length];for (int i$ = 0; i$ < length; i$++) {final int i = i$;array[i] = ((((int)(((Vector<java.lang.Integer>)(left)).apply$G((int)(i))))) * (((int)(((Vector<java.lang.Integer>)(right)).apply$G((int)(i))))));}return new x10.core.Rail<java.lang.Integer>(x10.rtt.Types.INT, left.
                                                                                                                                                                                                                                                                                                                                                                                                                                                        size, array);}}.apply(left.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                size)));
        }
...
//#line 20
return new Vector<java.lang.Integer>(x10.rtt.Types.INT,
                                                             (new java.lang.Object() {final x10.core.Rail<java.lang.Integer> apply(int length) {int[] array = new int[length];for (int i$ = 0; i$ < length; i$++) {final int i = i$;array[i] = ((((int)(((Vector<java.lang.Integer>)(left)).apply$G((int)(i))))) * (((int)(right))));}return new x10.core.Rail<java.lang.Integer>(x10.rtt.Types.INT, left.
                                                                                                                                                                                                                                                                                                                                                                                                       size, array);}}.apply(left.
                                                                                                                                                                                                                                                                                                                                                                                                                               size)));
        }
...
return new Vector<java.lang.Integer>(x10.rtt.Types.INT,
                                                             (new java.lang.Object() {final x10.core.Rail<java.lang.Integer> apply(int length) {int[] array = new int[length];for (int i$ = 0; i$ < length; i$++) {final int i = i$;array[i] = ((((int)(((Vector<java.lang.Integer>)(left)).apply$G((int)(i))))) > (((int)(((Vector<java.lang.Integer>)(right)).apply$G((int)(i))))))
                                                               ? 1
                                                               : 0;}return new x10.core.Rail<java.lang.Integer>(x10.rtt.Types.INT, left.
                                                                                                                                     size, array);}}.apply(left.
                                                                                                                                                             size)));
        }
...
return new Vector<java.lang.Double>(x10.rtt.Types.DOUBLE,
                                                            (new java.lang.Object() {final x10.core.Rail<java.lang.Double> apply(int length) {double[] array = new double[length];for (int i$ = 0; i$ < length; i$++) {final int i = i$;array[i] = ((((double)(((Vector<java.lang.Double>)(left)).apply$G((int)(i))))) * (((double)(((Vector<java.lang.Double>)(right)).apply$G((int)(i))))));}return new x10.core.Rail<java.lang.Double>(x10.rtt.Types.DOUBLE, left.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  size, array);}}.apply(left.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          size)));
        }
...
//#line 48
return new Vector<java.lang.Double>(x10.rtt.Types.DOUBLE,
                                                            (new java.lang.Object() {final x10.core.Rail<java.lang.Double> apply(int length) {double[] array = new double[length];for (int i$ = 0; i$ < length; i$++) {final int i = i$;array[i] = ((((double)(((Vector<java.lang.Double>)(left)).apply$G((int)(i))))) * (((double)(right))));}return new x10.core.Rail<java.lang.Double>(x10.rtt.Types.DOUBLE, left.
                                                                                                                                                                                                                                                                                                                                                                                                                  size, array);}}.apply(left.
                                                                                                                                                                                                                                                                                                                                                                                                                                          size)));
        }
