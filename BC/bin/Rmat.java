...
//#line 47
return (new java.lang.Object() {final x10.core.Rail<java.lang.Integer> apply(int length) {int[] array = new int[length];for (int id$77723$ = 0; id$77723$ < length; id$77723$++) {final int id$77723 = id$77723$;array[id$77723] = 0;}return new x10.core.Rail<java.lang.Integer>(x10.rtt.Types.INT, numElements, array);}}.apply(numElements));
        }
...
//#line 54
return (new java.lang.Object() {final x10.core.Rail<java.lang.Double> apply(int length) {double[] array = new double[length];for (int id$77724$ = 0; id$77724$ < length; id$77724$++) {final int id$77724 = id$77724$;array[id$77724] = rng.nextDouble();}return new x10.core.Rail<java.lang.Double>(x10.rtt.Types.DOUBLE, numElements, array);}}.apply(numElements));
        }
...
return (new java.lang.Object() {final x10.core.Rail<java.lang.Integer> apply(int length) {int[] array = new int[length];for (int i$ = 0; i$ < length; i$++) {final int i = i$;array[i] = ((((((double)(((double[])lhs.value)[i]))) > (((double)(rhs))))))
              ? 1
              : 0;}return new x10.core.Rail<java.lang.Integer>(x10.rtt.Types.INT, ((x10.core.Rail<java.lang.Double>)(lhs)).length(), array);}}.apply(((x10.core.Rail<java.lang.Double>)(lhs)).length()));
        }
...
return (new java.lang.Object() {final x10.core.Rail<java.lang.Double> apply(int length) {double[] array = new double[length];for (int i$ = 0; i$ < length; i$++) {final int i = i$;final int lhsMultiplier =
              ...
              ? ((((((((int)(((int[])lhs.value)[i]))) > (((int)(0))))))
                    ? 0
                    : 1))
              : ((int[])lhs.value)[i];array[i] = ((((double)(multiplier))) * (((double)((((double)(int)(((int)(lhsMultiplier)))))))));}return new x10.core.Rail<java.lang.Double>(x10.rtt.Types.DOUBLE, ((x10.core.Rail<java.lang.Integer>)(lhs)).length(), array);}}.apply(((x10.core.Rail<java.lang.Integer>)(lhs)).length()));
        }
...
//#line 93
return (new java.lang.Object() {final x10.core.Rail<java.lang.Integer> apply(int length) {int[] array = new int[length];for (int i$ = 0; i$ < length; i$++) {final int i = i$;array[i] = ((((int)(((int[])lhs.value)[i]))) * (((int)(multiplier))));}return new x10.core.Rail<java.lang.Integer>(x10.rtt.Types.INT, ((x10.core.Rail<java.lang.Integer>)(lhs)).length(), array);}}.apply(((x10.core.Rail<java.lang.Integer>)(lhs)).length()));
        }
...
//#line 99
return (new java.lang.Object() {final x10.core.Rail<java.lang.Double> apply(int length) {double[] array = new double[length];for (int i$ = 0; i$ < length; i$++) {final int i = i$;array[i] = ((((double)(((double[])lhs.value)[i]))) + (((double)(((double[])rhs.value)[i]))));}return new x10.core.Rail<java.lang.Double>(x10.rtt.Types.DOUBLE, ((x10.core.Rail<java.lang.Double>)(lhs)).length(), array);}}.apply(((x10.core.Rail<java.lang.Double>)(lhs)).length()));
        }
...
final AdjacencyGraph adjacencyGraph =
              ((AdjacencyGraph)(new AdjacencyGraph(this.
                                                     N)));
...
//#line 121
final int v =
                  ((java.lang.Integer)(((int[])row.value)[i]));
                
//#line 122
final int w =
                  ((java.lang.Integer)(((int[])col.value)[i]));
