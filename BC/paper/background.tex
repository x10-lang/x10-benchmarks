...
%
In fact, both $fringe$ and $BFS$ require $O(m)$ storage; for a large graph,
$fringe$ and $BFS$ even for a single start vertex (i.e., $nVerts==1$) might not
fit in memory without incurring excessive cache misses.
