...
nature are heterogeneous in nature (i.e., support shared- and distributed-memory
parallelism simultaneously), it is important to develop a parallel algorithm
that is also heterogeneous for optimal performance.
%
...
%
Furthermore, we develop a new heterogeneous algorithm for computing BC, which 
