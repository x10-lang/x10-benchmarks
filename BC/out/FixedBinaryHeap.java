...
//#line 21
public x10.core.fun.Fun_0_2<java.lang.Integer,java.lang.Integer,java.lang.Integer>
          comparator;
...
public FixedBinaryHeap(final x10.core.fun.Fun_0_2<java.lang.Integer,java.lang.Integer,java.lang.Integer> comparator,
                                           final int N,java.lang.Class $dummy0) {
            super();
            
//#line 17
this.__fieldInitializers428();
...
((int[])this.
        ...
        public static void
          ...
          final int indexOne,
          final int indexTwo,
          final FixedBinaryHeap FixedBinaryHeap){
            FixedBinaryHeap.swapElements((int)(indexOne),
                                         (int)(indexTwo));
        }
...
//#line 61
FixedBinaryHeap.__$closure$apply$__433(((FixedBinaryHeap)(this)),
                                                               (int)(1));
...
//#line 87
FixedBinaryHeap.__$closure$apply$__434(((FixedBinaryHeap)(this)),
                                                               (int)(1));
...
//#line 91
final int[] FixedBinaryHeap$this$internalHeap$value435 =
                  ((int[])this.
                            internalHeap.value);
...
if (((((int)((((((int)(c))) + (((int)(1)))))))) <= (((int)(this.
                                                                                             size)))) &&
                                    ((((int) 1) ==
                                      ((int) ((java.lang.Integer)comparator.apply(((int)FixedBinaryHeap$this$internalHeap$value435[((((int)(c))) + (((int)(1))))]),x10.rtt.Types.INT,
                                                                                  ((int)FixedBinaryHeap$this$internalHeap$value435[c]),x10.rtt.Types.INT)))))) {
...
//#line 100
if (((int) -1) !=
                                     ((int) ((java.lang.Integer)comparator.apply(((int)FixedBinaryHeap$this$internalHeap$value435[i]),x10.rtt.Types.INT,
                                                                                 ((int)FixedBinaryHeap$this$internalHeap$value435[c]),x10.rtt.Types.INT)))) {
...
//#line 136
final int[] FixedBinaryHeap$this$internalHeap$value436 =
                  ((int[])this.
                            internalHeap.value);
                
//#line 136
final int[] FixedBinaryHeap$this$indexMap$value437 =
                  ((int[])this.
                            indexMap.value);
...
x10.
                      ...
                      Console.OUT.print(((java.lang.String)((((((((((((int) i) ==
                                                                     ((int) 1)))
                                                                     ? ""
                                                                     : ",")) + (((java.lang.Integer)(((int)FixedBinaryHeap$this$internalHeap$value436[i])))))) + (":"))) + (((java.lang.Integer)(((int)FixedBinaryHeap$this$indexMap$value437[((int)FixedBinaryHeap$this$internalHeap$value436[i])]))))))));
                }
            }
...
this.size = 0;
        ...
        final public static void
          __fieldInitializers428$P(
          final FixedBinaryHeap FixedBinaryHeap){
            FixedBinaryHeap.__fieldInitializers428();
        }
        
        final private static int
          __$closure$apply$__433(
          final FixedBinaryHeap x,
          final int y){
...
return x.size = ((((int)(x.
        ...
        final public static int
          __$closure$apply$__433$P(
          final FixedBinaryHeap x,
          final int y){
            return FixedBinaryHeap.__$closure$apply$__433(((FixedBinaryHeap)(x)),
                                                          (int)(y));
        }
        
        final private static int
          __$closure$apply$__434(
          final FixedBinaryHeap x,
          final int y){
...
return x.size = ((((int)(x.
        ...
        final public static int
          __$closure$apply$__434$P(
          final FixedBinaryHeap x,
          final int y){
            return FixedBinaryHeap.__$closure$apply$__434(((FixedBinaryHeap)(x)),
                                                          (int)(y));
        }
