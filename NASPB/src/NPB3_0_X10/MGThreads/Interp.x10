...
public class Interp extends MGWorker {
	 ...
	 z1: Array[double](1){rail};
	 z2: Array[double](1){rail};
	 z3: Array[double](1){rail};
	
	public def this(mg: MG,  i: int) {
		super(mg, i);
		 m: int = 535;
		z1 = new Array[double](m);
		z2 = new Array[double](m);
		z3 = new Array[double](m);
	}
	...
	public static def interp( u: Array[Double](1){rail},  zoff: int, 
			 mm1: int,  mm2: int,  mm3: int,  uoff: int, 
			 n1: int,  n2: int,  n3: int, 
			 z1: Array[Double](1){rail},  z2: Array[Double](1){rail}, 
			 z3: Array[Double](1){rail},  start: int,  end: int) {
//		c---------------------------------------------------------------------
