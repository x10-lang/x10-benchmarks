...
public class MGBase {
	public static val BMName: String = "MG";
	public static  val maxlevel: int = 11;
	public var nit: int;
	...
	protected static val  T_total: int = 0;
	protected static val  T_init: int = 1;
	protected static val  T_bench: int = 2;
	protected static val  T_mg3P: int = 3;
	protected static val  T_psinv: int = 4;
	protected static val  T_resid: int = 5;
	protected static val  T_resid2: int = 6;
	protected static val  T_rprj3: int = 7;
	protected static val  T_interp: int = 8;
	protected static val  T_norm2: int = 9;
	protected static val  T_last: int = 9;
