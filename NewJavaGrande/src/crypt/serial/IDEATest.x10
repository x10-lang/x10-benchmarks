...
public class IDEATest {
	...
	var plain1: Array[int];       // Buffer for plaintext data.
	var crypt1: Array[int];       // Buffer for encrypted data.
	var plain2: Array[int];       // Buffer for decrypted data.
	...
	def buildTestData(): void {
		...
		plain1 = new Array[int](array_rows);
		...
		Z = new Array[int](52);         // Encryption subkey (user key derived).
		DK = new Array[int](52);        // Decryption subkey (user key derived).
