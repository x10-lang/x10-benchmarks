...
import sparsematmult.distributed.sparsematmult.*;
import jgfutil.*;
import x10.util.*;
...
public class JGFSparseMatmultBench extends SparseMatmult implements JGFSection2 {
	...
	public def JGFinitialise(): void = {
		...
		val d_M: Dist = Dist.makeBlock(0..(ds_M-1), 0, PlaceGroup.WORLD);
		...
		// TODO: vall = DistArray.make[double]((0..(valt.size-1))->here), ([i]: Point): double => { return valt(i); });
