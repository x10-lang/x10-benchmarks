    ...
    def kernel_jacobi_1d_imper(tsteps : long, n : long, A : Rail[double], B : Rail[double])  {
        ...
        if (((n >= 3) && (tsteps >= 1))) {
            ...
            for (c0 = 2; (c0 <= ((n + (3 * tsteps)) + -5)); c0++) {
                ...
                {
                    val c0_1 = c0;
                    Foreach.block(((((2 * c0_1) + 2) * 3 < 0 ?  -( -(((2 * c0_1) + 2)) / 3) : (3 < 0 ? ( -(((2 * c0_1) + 2)) +  -(3) - 1) /  -(3) : (((2 * c0_1) + 2) + 3 - 1) / 3)) > ((c0_1 + (-1 * tsteps)) + 1) ? ((((2 * c0_1) + 2) * 3 < 0 ?  -( -(((2 * c0_1) + 2)) / 3) : (3 < 0 ? ( -(((2 * c0_1) + 2)) +  -(3) - 1) /  -(3) : (((2 * c0_1) + 2) + 3 - 1) / 3))) as long : (((c0_1 + (-1 * tsteps)) + 1)) as long),(((((2 * c0_1) + n) + -2) * 3 < 0 ? (3 < 0 ?  -(( -((((2 * c0_1) + n) + -2)) + 3 + 1) / 3) :  -(( -((((2 * c0_1) + n) + -2)) + 3 - 1) / 3)) : (((2 * c0_1) + n) + -2) / 3) < c0_1 ? (((((2 * c0_1) + n) + -2) * 3 < 0 ? (3 < 0 ?  -(( -((((2 * c0_1) + n) + -2)) + 3 + 1) / 3) :  -(( -((((2 * c0_1) + n) + -2)) + 3 - 1) / 3)) : (((2 * c0_1) + n) + -2) / 3)) as long : (c0_1) as long),(var c1 : long) => {
                        B(((-2 * c0_1) + (3 * c1))) = 0.33333 * (A(((-2 * c0_1) + (3 * c1)) - 1L) + A(((-2 * c0_1) + (3 * c1))) + A(((-2 * c0_1) + (3 * c1)) + 1L));
                        A((((-2 * c0_1) + (3 * c1)) + -1)) = B((((-2 * c0_1) + (3 * c1)) + -1));
                    }
);
                }
                if ((c0 >= (n + -1))) {
