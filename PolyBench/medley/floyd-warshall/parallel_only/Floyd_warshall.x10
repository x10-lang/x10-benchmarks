...
public class Floyd_warshall {
  ...
  
  {
    ...
    def kernel_floyd_warshall(n : long, path : Array_2[double])  {
        ...
        if ((n >= 1)) {
            for (c0 = 0; (c0 <= (n + -1)); c0++) {
                for (c1 = 0; (c1 <= ((2 * n) + -2)); c1++) {
                    {
                        val c0_2 = c0;
                        val c1_1 = c1;
                        Foreach.block((0 > ((c1_1 + (-1 * n)) + 1) ? (0) as long : (((c1_1 + (-1 * n)) + 1)) as long),(c1_1 < (n + -1) ? (c1_1) as long : ((n + -1)) as long),(var c2 : long) => {
                            path((c1_1 + (-1 * c2)),c2) = (path((c1_1 + (-1 * c2)),c2) < path((c1_1 + (-1 * c2)),c0_2) + path(c0_2,c2) ? path((c1_1 + (-1 * c2)),c2) : path((c1_1 + (-1 * c2)),c0_2) + path(c0_2,c2));
                        }
);
                    }
                }
